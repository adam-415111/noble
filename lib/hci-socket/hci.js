...
Hci.prototype.setScanParameters = function() {
  ...
  //cmd.writeUInt16LE(0x0348, 5); // internal, ms * 1.6
  // cmd.writeUInt16LE(0x0118, 7); // window, ms * 1.6
...
Hci.prototype.createLeConn = function(address, addressType) {
  ...
  // data
  cmd.writeUInt16LE(0x0348, 4); // interval
  cmd.writeUInt16LE(0x0118, 6); // window
  ...
  cmd.writeUInt16LE(0x000f, 17); // min interval
  cmd.writeUInt16LE(0x001e, 19); // max interval
...
Hci.prototype.cancelLeConn = function() {
  ...
  // length
  cmd.writeUInt8(0x0, 3);
  console.log('cancel le conn - writing: ' + cmd.toString('hex'));
